...
GamesController = {
  ...
  UpdateGame: (req, res) => {
    ...
    Game.update(
      { address: req.body.address, competitive: req.body.competitive, coordinates: req.body.coordinates, end: req.body.end, max: req.body.max, notes: req.body.notes, sport: req.body.sport, start: req.body.start },
